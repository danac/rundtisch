...
// Pexels only resizes by width and keeps the original ratio — width/height
// on the Photo must match the file or the mosaic will stretch the tile.
...
const serenityPhotos: Photo[] = [
  ...
  photo('serenity-spa', 4, pexels('3188', 'love-romantic-bath-candlelight.jpg', 900), 900, 1359, 'Rolled towel with candles and a tulip', 'Ritual'),
  ...
  photo('serenity-spa', 10, pexels('3764568', 'pexels-photo-3764568.jpeg', 1000), 1000, 667, 'Neck and shoulder treatment', 'Quiet'),
  photo('serenity-spa', 11, unsplash('photo-1441974231531-c6227db76b6e', 1100, 900), 1100, 900, 'Path through a green forest', 'Walk'),
  photo('serenity-spa', 12, pexels('3865530', 'pexels-photo-3865530.jpeg', 900), 900, 600, 'Close massage on the collarbone', 'Soft'),
  photo('serenity-spa', 13, unsplash('photo-1570172619644-dfd03ed5d881', 1600, 900), 1600, 900, 'Facial mask applied with a brush', 'Mask'),
  photo('serenity-spa', 14, pexels('3757942', 'pexels-photo-3757942.jpeg', 1000), 1000, 667, 'Guest resting after treatment', 'Rest'),
  photo('serenity-spa', 15, pexels('3865676', 'pexels-photo-3865676.jpeg', 1400), 1400, 2100, 'Oils, flowers, and stones', 'Blend'),
...
const coastPhotos: Photo[] = [
  ...
  photo('north-coast', 2, unsplash('photo-1500375592092-40eb2168fd21', 1200, 1600), 1200, 1600, 'Cliff above the sea', 'Cliff'),
  ...
  photo('north-coast', 7, unsplash('photo-1473116763249-2faaef81ccda', 1000, 900), 1000, 900, 'Open water', 'Horizon'),
]
